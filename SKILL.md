...
## 风格锚点
三种风格，按需选用。一般不需要调用，当用户有明确风格偏好或写出来味道不对时再调用。完整示例见 [references/style-anchors.md](references/style-anchors.md)。
...
**叙述感 vs 装逼感：**
- ❌ 太文绉绉，像在写作文："我站在大理古城的青石板路上，抬头仰望，午后的阳光温柔地洒在苍山的云层上"
- ✅ 具体的观察，有画面，有交谈感："古城在下午四点时候会洒下来一种特别的光，那个时刻苍山上面的云会压得很低，是贴着山脊的一层灰白色"
...
**纯议论写法要点：**
- 保留用户核心观点，有具体场景（地铁车厢画面）
- 感悟对自己说（「不是的，这种"正常"根本就有问题」），不对读者说教
- 结尾无鸡汤，可以停在拧巴感里，不需要和解或答案（「先这样过着吧」）

> 完整正反面示例（含完整 prose）见 [references/writing-samples.md](references/writing-samples.md)。
